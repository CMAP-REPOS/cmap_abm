...
public class JointTourFrequencyModel {
    ...
    private void applyJointTourFrequencyChoice( HouseholdIf household ) {
    ...
    private void jointTourParticipation( TourIf jointTour ) {

        // get the Household object for this joint tour
        HouseholdIf hh = dmuObject.getHouseholdObject();
        ...
        String key = String.format( "%s_%d_%d_%d", jointTour.getTourPrimaryPurpose(), jointTour.getJointTourComposition(), adults, children );
     ...
     * @param chosenAlt
     */
    private void createJointTours ( HouseholdIf household, int chosenAlt ) {
        Object[] t1Data = null;
        Object[] t2Data = null;
        ...
        if (t1Data == null) {
            ...
            if (t2Data == null) {
                household.createJointTourArray(t1Data);
            } else {
                household.createJointTourArray(t1Data,t2Data);
            }
        }
