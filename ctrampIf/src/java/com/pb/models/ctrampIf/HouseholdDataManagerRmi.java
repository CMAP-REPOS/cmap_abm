...
public class HouseholdDataManagerRmi implements HouseholdDataManagerIf, Serializable {
    ...
    public HouseholdIf[] getHhArray() {
        Object[] objArray = {};
        return (HouseholdIf[])remote.method( "getHhArray", objArray);
    }
    ...
    public void setHhArray( HouseholdIf[] hhs ) {
        Object[] objArray = { hhs };
    ...
    public HouseholdIf[] createHhArrayFromSerializedObjectInFile( String serializedObjectFileName, String serializedObjectKey ) {
        Object[] objArray = { serializedObjectFileName, serializedObjectKey };
        return (HouseholdIf[])remote.method( "createHhArrayFromSerializedObjectInFile", objArray);
    }
