...
import com.pb.models.ctrampIf.jppf.MandatoryDestChoiceModel;
...
public class LocationChoiceTaskJppf<T> extends AbstractTask<T> {
    ...
    public void run() {
        ...
        try {
            ...
            this.modeChoiceUecFileName = (String) dataProvider.getParameter("modeChoiceUecFileName");
...
//        long[][] coeffCount = new long[dcModel.getCoeffCount().length][dcModel.getCoeffCount()[0].length];
        ...
        HouseholdIf[] householdArray = null;
