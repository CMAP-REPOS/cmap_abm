...
public class JointTourFrequencyDMU implements Serializable, VariableTable {
    ...
    public int getPersonIsAdult() {
        PersonIf p = tour.getPersonObject();
    ...
    public int getTourPurposeIsEat () {
        return tour.getTourPrimaryPurpose().equalsIgnoreCase( modelStructure.EAT_OUT_PURPOSE_NAME ) ? 1 : 0;
    }

    public int getTourPurposeIsDiscretionary () {
        return tour.getTourPrimaryPurpose().equalsIgnoreCase( modelStructure.OTH_DISCR_PURPOSE_NAME ) ? 1 : 0;
    }
