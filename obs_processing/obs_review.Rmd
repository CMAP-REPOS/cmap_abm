...
Unlinked:
`r obs_data[, sum(unlinked_weight, na.rm = TRUE)]`

Linked:
`r obs_data[, sum(linked_weight, na.rm = TRUE)]`
...
cols = c('Metra', 'CTA Rail', 'CTA Bus') 
boardings = boardings[order(-Metra, -`CTA Rail`, -`CTA Bus`)]
