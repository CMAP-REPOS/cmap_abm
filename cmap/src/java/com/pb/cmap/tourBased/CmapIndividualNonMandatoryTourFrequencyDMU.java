 ...
 *
 */
public class CmapIndividualNonMandatoryTourFrequencyDMU extends IndividualNonMandatoryTourFrequencyDMU {


    public CmapIndividualNonMandatoryTourFrequencyDMU(){
    	super();
        setupMethodIndexMap();
    }
    ...
    private void setupMethodIndexMap() {
        ...
        methodIndexMap.put( "getNumJointMaintenanceTours", 46 );
        methodIndexMap.put( "getNumJointEatingOutTours", 47 );
        methodIndexMap.put( "getNumJointVisitingTours", 48 );
        methodIndexMap.put( "getNumJointDiscretionaryTours", 49 );
