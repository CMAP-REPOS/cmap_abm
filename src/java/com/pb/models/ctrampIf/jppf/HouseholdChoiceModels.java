...
public class HouseholdChoiceModels implements Serializable {
    ...
    private NonMandatoryTourDepartureAndDurationTime jTodModel;
    ...
    private NonMandatoryTourDepartureAndDurationTime inmTodModel;
    ...
    private long[] returnPartialTimes = new long[StopLocationModeChoiceModel.NUM_CPU_TIME_VALUES];
    ...
    private void setupModels( HashMap<String, String> propertyMap, TazDataIf tazDataManager, ModelStructure modelStructure, CtrampDmuFactoryIf dmuFactory ) throws IOException {
        ...
        try {
            ...
            if ( runAutoOwnershipModel ) {
                aoModel = new HouseholdAutoOwnershipModel( propertyMap, dmuFactory, tazDataManager, modelStructure );
            ...
            if ( runJointTourDepartureTimeAndDurationModel ){
                jTodModel = new NonMandatoryTourDepartureAndDurationTime( propertyMap, modelStructure, dmuFactory, ModelStructure.JOINT_NON_MANDATORY_CATEGORY, jmcModel );        
            ...
            if ( runIndividualNonMandatoryTourDepartureTimeAndDurationModel ){
                inmTodModel = new NonMandatoryTourDepartureAndDurationTime( propertyMap, modelStructure, dmuFactory, ModelStructure.INDIVIDUAL_NON_MANDATORY_CATEGORY, inmmcModel );
    ...
    public void runModels( HouseholdIf hhObject ) {
        ...
        if ( runJointTourDepartureTimeAndDurationModel )
            jTodModel.applyJointModel( hhObject, runJointTourModeChoiceModel );
        ...
        if ( runIndividualNonMandatoryTourDepartureTimeAndDurationModel )
            inmTodModel.applyIndivModel( hhObject, runIndividualNonMandatoryTourModeChoiceModel );
    ...
    public void runModelsWithTiming( HouseholdIf hhObject ) {
    ...
    private void checkRestartModel( HouseholdIf hhObject ) {
