...
public class HouseholdCoordinatedDailyActivityPatternModel implements Serializable {
    ...
    private PersonIf[] cdapPersonArray;
    ...
    public void applyModel( HouseholdIf hhObject ){
        ...
        if( hhObject.getDebugChoiceModels() ){
            ...
            for(int j=1;j<personArray.length;++j){
                ...
                PersonIf[] tempPersonArray = getPersonsNotModeledByCdap(MAX_MODEL_HH_SIZE);
    ...
    public PersonIf[] getPersonsNotModeledByCdap(int personsModeledByCdap){
        ...
        PersonIf[] personArray = null;
        if ( cdapPersonArray.length > personsModeledByCdap + 1 )
            personArray = new PersonIf[cdapPersonArray.length - personsModeledByCdap];
        else
            personArray = new PersonIf[0];
