...
public class DestinationSampleOfAlternativesModel implements Serializable {
    ...
    public void computeDestinationSampleOfAlternatives( DcSoaDMU dcSoaDmuObject, TourIf tour, PersonIf person, String purposeName, int purposeIndex ) {
        ...
        HouseholdIf hhObj = person.getHouseholdObject();
     ...
     */
    private void computeSampleOfAlternativesChoiceProbabilities( ChoiceModelApplication choiceModel, DcSoaDMU dcSoaDmuObject, TourIf tour, PersonIf person, String purposeName, int purposeIndex, int origTaz ) {
        ...
        // set the person object for this DMU object
        ...
        if ( tour != null && tour.getTourCategoryIsAtWork() ) {
            subtourCumProbabilitiesCache[purposeIndex] = choiceModel.getCumulativeProbabilities();
            subtourProbabilitiesCache[purposeIndex] = choiceModel.getProbabilities();
        }
        else {
            cumProbabilitiesCache[purposeIndex] = choiceModel.getCumulativeProbabilities();
            probabilitiesCache[purposeIndex] = choiceModel.getProbabilities();
        }
