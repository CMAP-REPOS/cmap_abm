...
public interface TazDataIf {
    ...
    /**
     * @return integer grade school value from the zone data table for the zone index.
     */
    public int[] getZonalGradeSchool ();
    
    /**
     * @return integer high school value from the zone data table for the zone index.
     */
