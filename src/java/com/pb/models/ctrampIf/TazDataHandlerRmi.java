...
public class TazDataHandlerRmi implements TazDataIf, Serializable {
    ...
    public int[] getZonalGradeSchool () {
        Object[] objArray = {};
        return (int[])remote.method( "getZonalGradeSchool", objArray);
    }
    
    public int[] getZonalHighSchool () {
        Object[] objArray = {};
        return (int[])remote.method( "getZonalHighSchool", objArray);
    }
    ...
    public float[] getBHHDen() {
        Object[] objArray = {};
        return (float[])remote.method( "getBHHDen", objArray);
    }
    
    public float[] getBEmpDen() {
        Object[] objArray = {};
        return (float[])remote.method( "getBEmpDen", objArray);
    }
    
    public float[] getPef() {
        Object[] objArray = {};
        return (float[])remote.method( "getPef", objArray);
    }
    
    public int[] getRing() {
        Object[] objArray = {};
        return (int[])remote.method( "getRing", objArray);
    }
    ...
    public float[] getAccess17Accessibity() {
        Object[] objArray = {};
        return (float[])remote.method( "getAccess17Accessibity", objArray);
    }
    
    public float[] getAccess18Accessibity() {
        Object[] objArray = {};
        return (float[])remote.method( "getAccess18Accessibity", objArray);
    }

    public float getOMazDMazDistance(int omaz, int dmaz) {
    	Object[] objArray = { omaz, dmaz };
        return (Float)remote.method( "getOMazDMazDistance", objArray);
    }
    
    public float[] getOMazDistances(int omaz) {
    	Object[] objArray = { omaz };
        return (float[])remote.method( "getOMazDistances", objArray);
    }
    
    public float[] getAltDistances(int alt) {
    	Object[] objArray = { alt };
        return (float[])remote.method( "getAltDistances", objArray);
    }
    
    public int getHasTransitAccess(int maz) {
    	Object[] objArray = { maz };
        return (Integer)remote.method( "getHasTransitAccess", objArray);
    }
    
    public int[] getTazsForMazs() {
        Object[] objArray = {};
        return (int[])remote.method( "getTazsForMazs", objArray);
    }
    
    public MazTapTazData getMttData() {
        Object[] objArray = {};
        return (MazTapTazData)remote.method( "getMttData", objArray);
    }
