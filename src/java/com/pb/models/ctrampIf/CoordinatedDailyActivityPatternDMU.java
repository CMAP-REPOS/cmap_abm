...
public class CoordinatedDailyActivityPatternDMU implements Serializable, VariableTable {
    ...
    protected HouseholdIf householdObject;
    protected PersonIf personA, personB, personC;
    ...
    public void setHousehold(HouseholdIf passedInHouseholdObject){
    ...
    public void setPersonA(PersonIf passedInPersonA){
    	this.personA = passedInPersonA;
    }
    
    public void setPersonB(PersonIf passedInPersonB){
    	this.personB = passedInPersonB;
    }
    
    public void setPersonC(PersonIf passedInPersonC){
