...
public class CmapCoordinatedDailyActivityPatternDMU extends CoordinatedDailyActivityPatternDMU {


    
    public CmapCoordinatedDailyActivityPatternDMU() {
        super ();
        setupMethodIndexMap();
    }
    ...
    // household income
    // TODO make sure this is the right income (check where in syn pop file it comes from)
    public int getIncomeLess20k(){
    	int incomeQuartile = householdObject.getIncomeSegment();
    	if(incomeQuartile==1) return 1;
    	return 0;
    }
    
    public int getIncome50to100k(){
    	int incomeQuartile = householdObject.getIncomeSegment();
    	if(incomeQuartile==3) return 1;
    	return 0;
    }
    
    public int getIncomeMore100k(){
    	int incomeQuartile = householdObject.getIncomeSegment();
    	if(incomeQuartile==4) return 1;
    	return 0;
    }
