...
public class CmapJointTourFrequencyDMU extends JointTourFrequencyDMU {
    ...
    /**
     * @return 1 if "decision making" household is LOW, 0 otherwise.
     */
    ...
    private void setupMethodIndexMap() {
        ...
        methodIndexMap.put( "getHhIncome", 24 );
