 ...
 */
public class CmapTourDepartureTimeAndDurationDMU extends TourDepartureTimeAndDurationDMU {

	TazDataIf tazDataManager;
    
    public CmapTourDepartureTimeAndDurationDMU(TazDataIf tazDataManager, ModelStructure modelStructure ){
    ...
    public float getIncome() {
    	return household.getIncomeSegment();
    }
    ...
    {
        return ( getUniversityStudent() == 1 && person.getCdapActivity().equalsIgnoreCase(ModelStructure.MANDATORY_PATTERN )) ? 1 : 0;
    }

    public int getWorkerWithMandatoryPattern()
    {
        return ( (getFullTimeWorker() == 1 || getPartTimeWorker() ==1) && person.getCdapActivity().equalsIgnoreCase(ModelStructure.MANDATORY_PATTERN )) ? 1 : 0;
    }
    ...
    private void setupMethodIndexMap()
    {
        ...
        methodIndexMap.put("getOriginAreaType", 46);
        methodIndexMap.put("getDestinationAreaType", 47);
        methodIndexMap.put("getNumPreschoolChildrenInHh", 48);
        methodIndexMap.put("getPersonType", 49);
        methodIndexMap.put("getIncome", 50);
    ...
    public double getValueForIndex(int variableIndex, int arrayIndex)
    {
        ...
        switch (variableIndex)
        {
            ...
            case 44:
                ...
                break;
            case 45:
                returnValue = getMaxJointTimeWindow( tour );
                break;
            case 46:
                returnValue = getOriginAreaType();
                break;
            case 47:
                returnValue = getDestinationAreaType();
                break;
            case 48:
                returnValue = getNumPreschoolChildrenInHh();
                break;
            case 49:
            ...
            case 50:
                ...
                break;
            case 88: 
            	returnValue = getOMazDMazDistance();
            	break;
