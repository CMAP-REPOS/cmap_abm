...
matrices = _json.load(open("asim_files.json", "r"))

print("Scenario 1 file is %s"%(list(filter(lambda x:x['scenario']==1, matrices))))


ASIM_OUTPUT_FOLDER = "C:\\projects\\cmap_activitysim\\cmap_abm\\activitysim\\outputs\\"
