...
bin_xwalk = data.frame(bin48 = seq(1,48), 
                       bin23 = seq(1,48)) # c(rep(3:24,each = 2), rep(1:2, each = 2)))
...
# TOD Profile
tod1 = wtd.hist(tours$ANCHOR_DEPART_BIN_RECODE[tours$TOURPURP==1 & tours$IS_SUBTOUR == 0], breaks = seq(1,48, by=1), freq = NULL, right=FALSE, weight = tours$finalweight[tours$TOURPURP==1 & tours$IS_SUBTOUR == 0])
tod2 = wtd.hist(tours$ANCHOR_DEPART_BIN_RECODE[tours$TOURPURP==2 & tours$IS_SUBTOUR == 0], breaks = seq(1,48, by=1), freq = NULL, right=FALSE, weight = tours$finalweight[tours$TOURPURP==2 & tours$IS_SUBTOUR == 0])
tod3 = wtd.hist(tours$ANCHOR_DEPART_BIN_RECODE[tours$TOURPURP==3 & tours$IS_SUBTOUR == 0], breaks = seq(1,48, by=1), freq = NULL, right=FALSE, weight = tours$finalweight[tours$TOURPURP==3 & tours$IS_SUBTOUR == 0])
tod4 = wtd.hist(tours$ANCHOR_DEPART_BIN_RECODE[tours$TOURPURP==4 & tours$IS_SUBTOUR == 0], breaks = seq(1,48, by=1), freq = NULL, right=FALSE, weight = tours$finalweight[tours$TOURPURP==4 & tours$IS_SUBTOUR == 0])
todi56 = wtd.hist(tours$ANCHOR_DEPART_BIN_RECODE[tours$TOURPURP>=5 & tours$TOURPURP<=6 & tours$FULLY_JOINT==0 & tours$IS_SUBTOUR == 0], breaks = seq(1,48, by=1), freq = NULL, right=FALSE, weight = tours$finalweight[tours$TOURPURP>=5 & tours$TOURPURP<=6 & tours$FULLY_JOINT==0 & tours$IS_SUBTOUR == 0])
todi789 = wtd.hist(tours$ANCHOR_DEPART_BIN_RECODE[tours$TOURPURP>=7 & tours$TOURPURP<=9 & tours$FULLY_JOINT==0 & tours$IS_SUBTOUR == 0], breaks = seq(1,48, by=1), freq = NULL, right=FALSE, weight = tours$finalweight[tours$TOURPURP>=7 & tours$TOURPURP<=9 & tours$FULLY_JOINT==0 & tours$IS_SUBTOUR == 0])
todj56 = wtd.hist(jtours$ANCHOR_DEPART_BIN_RECODE[jtours$JOINT_PURP>=5 & jtours$JOINT_PURP<=6], breaks = seq(1,48, by=1), freq = NULL, right=FALSE, weight = jtours$finalweight[jtours$JOINT_PURP>=5 & jtours$JOINT_PURP<=6])
todj789 = wtd.hist(jtours$ANCHOR_DEPART_BIN_RECODE[jtours$JOINT_PURP>=7 & jtours$JOINT_PURP<=9], breaks = seq(1,48, by=1), freq = NULL, right=FALSE, weight = jtours$finalweight[jtours$JOINT_PURP>=7 & jtours$JOINT_PURP<=9])
tod15 = wtd.hist(tours$ANCHOR_DEPART_BIN_RECODE[tours$IS_SUBTOUR == 1], breaks = seq(1,48, by=1), freq = NULL, right=FALSE, weight = tours$finalweight[tours$IS_SUBTOUR == 1])
...
arr1 = wtd.hist(tours$ANCHOR_ARRIVE_BIN_RECODE[tours$TOURPURP==1 & tours$IS_SUBTOUR == 0], breaks = seq(1,48, by=1), freq = NULL, right=FALSE, weight = tours$finalweight[tours$TOURPURP==1 & tours$IS_SUBTOUR == 0])
arr2 = wtd.hist(tours$ANCHOR_ARRIVE_BIN_RECODE[tours$TOURPURP==2 & tours$IS_SUBTOUR == 0], breaks = seq(1,48, by=1), freq = NULL, right=FALSE, weight = tours$finalweight[tours$TOURPURP==2 & tours$IS_SUBTOUR == 0])
arr3 = wtd.hist(tours$ANCHOR_ARRIVE_BIN_RECODE[tours$TOURPURP==3 & tours$IS_SUBTOUR == 0], breaks = seq(1,48, by=1), freq = NULL, right=FALSE, weight = tours$finalweight[tours$TOURPURP==3 & tours$IS_SUBTOUR == 0])
arr4 = wtd.hist(tours$ANCHOR_ARRIVE_BIN_RECODE[tours$TOURPURP==4 & tours$IS_SUBTOUR == 0], breaks = seq(1,48, by=1), freq = NULL, right=FALSE, weight = tours$finalweight[tours$TOURPURP==4 & tours$IS_SUBTOUR == 0])
arri56 = wtd.hist(tours$ANCHOR_ARRIVE_BIN_RECODE[tours$TOURPURP>=5 & tours$TOURPURP<=6 & tours$FULLY_JOINT==0 & tours$IS_SUBTOUR == 0], breaks = seq(1,48, by=1), freq = NULL, right=FALSE, weight = tours$finalweight[tours$TOURPURP>=5 & tours$TOURPURP<=6 & tours$FULLY_JOINT==0 & tours$IS_SUBTOUR == 0])
arri789 = wtd.hist(tours$ANCHOR_ARRIVE_BIN_RECODE[tours$TOURPURP>=7 & tours$TOURPURP<=9 & tours$FULLY_JOINT==0 & tours$IS_SUBTOUR == 0], breaks = seq(1,48, by=1), freq = NULL, right=FALSE, weight = tours$finalweight[tours$TOURPURP>=7 & tours$TOURPURP<=9 & tours$FULLY_JOINT==0 & tours$IS_SUBTOUR == 0])
arrj56 = wtd.hist(jtours$ANCHOR_ARRIVE_BIN_RECODE[jtours$JOINT_PURP>=5 & jtours$JOINT_PURP<=6], breaks = seq(1,48, by=1), freq = NULL, right=FALSE, weight = jtours$finalweight[jtours$JOINT_PURP>=5 & jtours$JOINT_PURP<=6])
arrj789 = wtd.hist(jtours$ANCHOR_ARRIVE_BIN_RECODE[jtours$JOINT_PURP>=7 & jtours$JOINT_PURP<=9], breaks = seq(1,48, by=1), freq = NULL, right=FALSE, weight = jtours$finalweight[jtours$JOINT_PURP>=7 & jtours$JOINT_PURP<=9])
arr15 = wtd.hist(tours$ANCHOR_ARRIVE_BIN_RECODE[tours$IS_SUBTOUR == 1], breaks = seq(1,48, by=1), freq = NULL, right=FALSE, weight = tours$finalweight[tours$IS_SUBTOUR == 1])
...
#Stop Departure Time
stopfreq1 = wtd.hist(stops$DEST_DEP_BIN_RECODE[stops$TOURPURP==1 & stops$IS_SUBTOUR == 0], breaks = c(seq(1,48, by=1), 9999), freq = NULL, right=FALSE, weight = stops$finalweight[stops$TOURPURP==1 & stops$IS_SUBTOUR == 0])
stopfreq2 = wtd.hist(stops$DEST_DEP_BIN_RECODE[stops$TOURPURP==2 & stops$IS_SUBTOUR == 0], breaks = c(seq(1,48, by=1), 9999), freq = NULL, right=FALSE, weight = stops$finalweight[stops$TOURPURP==2 & stops$IS_SUBTOUR == 0])
stopfreq3 = wtd.hist(stops$DEST_DEP_BIN_RECODE[stops$TOURPURP==3 & stops$IS_SUBTOUR == 0], breaks = c(seq(1,48, by=1), 9999), freq = NULL, right=FALSE, weight = stops$finalweight[stops$TOURPURP==3 & stops$IS_SUBTOUR == 0])
stopfreq4 = wtd.hist(stops$DEST_DEP_BIN_RECODE[stops$TOURPURP==4 & stops$IS_SUBTOUR == 0], breaks = c(seq(1,48, by=1), 9999), freq = NULL, right=FALSE, weight = stops$finalweight[stops$TOURPURP==4 & stops$IS_SUBTOUR == 0])
stopfreqi56 = wtd.hist(stops$DEST_DEP_BIN_RECODE[stops$TOURPURP>=5 & stops$TOURPURP<=6 & stops$FULLY_JOINT==0 & stops$IS_SUBTOUR == 0], breaks = c(seq(1,48, by=1), 9999), freq = NULL, right=FALSE, weight = stops$finalweight[stops$TOURPURP>=5 & stops$TOURPURP<=6 & stops$FULLY_JOINT==0 & stops$IS_SUBTOUR == 0])
stopfreqi789 = wtd.hist(stops$DEST_DEP_BIN_RECODE[stops$TOURPURP>=7 & stops$TOURPURP<=9 & stops$FULLY_JOINT==0 & stops$IS_SUBTOUR == 0], breaks = c(seq(1,48, by=1), 9999), freq = NULL, right=FALSE, weight = stops$finalweight[stops$TOURPURP>=7 & stops$TOURPURP<=9 & stops$FULLY_JOINT==0 & stops$IS_SUBTOUR == 0])
stopfreqj56 = wtd.hist(jstops$DEST_DEP_BIN_RECODE[jstops$TOURPURP>=5 & jstops$TOURPURP<=6], breaks = c(seq(1,48, by=1), 9999), freq = NULL, right=FALSE, weight = jstops$finalweight[jstops$TOURPURP>=5 & jstops$TOURPURP<=6])
stopfreqj789 = wtd.hist(jstops$DEST_DEP_BIN_RECODE[jstops$TOURPURP>=7 & jstops$TOURPURP<=9], breaks = c(seq(1,48, by=1), 9999), freq = NULL, right=FALSE, weight = jstops$finalweight[jstops$TOURPURP>=7 & jstops$TOURPURP<=9])
stopfreq10 = wtd.hist(stops$DEST_DEP_BIN_RECODE[stops$SUBTOUR==1], breaks = c(seq(1,48, by=1), 9999), freq = NULL, right=FALSE, weight = stops$finalweight[stops$SUBTOUR==1])
...
#Trip Departure Time
stopfreq1 = wtd.hist(trips$ORIG_DEP_BIN_RECODE[trips$TOURPURP==1 & trips$IS_SUBTOUR == 0], breaks = c(seq(1,48, by=1), 9999), freq = NULL, right=FALSE, weight = trips$finalweight[trips$TOURPURP==1 & trips$IS_SUBTOUR == 0])
stopfreq2 = wtd.hist(trips$ORIG_DEP_BIN_RECODE[trips$TOURPURP==2 & trips$IS_SUBTOUR == 0], breaks = c(seq(1,48, by=1), 9999), freq = NULL, right=FALSE, weight = trips$finalweight[trips$TOURPURP==2 & trips$IS_SUBTOUR == 0])
stopfreq3 = wtd.hist(trips$ORIG_DEP_BIN_RECODE[trips$TOURPURP==3 & trips$IS_SUBTOUR == 0], breaks = c(seq(1,48, by=1), 9999), freq = NULL, right=FALSE, weight = trips$finalweight[trips$TOURPURP==3 & trips$IS_SUBTOUR == 0])
stopfreq4 = wtd.hist(trips$ORIG_DEP_BIN_RECODE[trips$TOURPURP==4 & trips$IS_SUBTOUR == 0], breaks = c(seq(1,48, by=1), 9999), freq = NULL, right=FALSE, weight = trips$finalweight[trips$TOURPURP==4 & trips$IS_SUBTOUR == 0])
stopfreqi56 = wtd.hist(trips$ORIG_DEP_BIN_RECODE[trips$TOURPURP>=5 & trips$TOURPURP<=6 & trips$FULLY_JOINT==0 & trips$IS_SUBTOUR == 0], breaks = c(seq(1,48, by=1), 9999), freq = NULL, right=FALSE, weight = trips$finalweight[trips$TOURPURP>=5 & trips$TOURPURP<=6 & trips$FULLY_JOINT==0 & trips$IS_SUBTOUR == 0])
stopfreqi789 = wtd.hist(trips$ORIG_DEP_BIN_RECODE[trips$TOURPURP>=7 & trips$TOURPURP<=9 & trips$FULLY_JOINT==0 & trips$IS_SUBTOUR == 0], breaks = c(seq(1,48, by=1), 9999), freq = NULL, right=FALSE, weight = trips$finalweight[trips$TOURPURP>=7 & trips$TOURPURP<=9 & trips$FULLY_JOINT==0 & trips$IS_SUBTOUR == 0])
stopfreqj56 = wtd.hist(jtrips$ORIG_DEP_BIN_RECODE[jtrips$TOURPURP>=5 & jtrips$TOURPURP<=6], breaks = c(seq(1,48, by=1), 9999), freq = NULL, right=FALSE, weight = jtrips$finalweight[jtrips$TOURPURP>=5 & jtrips$TOURPURP<=6])
stopfreqj789 = wtd.hist(jtrips$ORIG_DEP_BIN_RECODE[jtrips$TOURPURP>=7 & jtrips$TOURPURP<=9], breaks = c(seq(1,48, by=1), 9999), freq = NULL, right=FALSE, weight = jtrips$finalweight[jtrips$TOURPURP>=7 & jtrips$TOURPURP<=9])
stopfreq10 = wtd.hist(trips$ORIG_DEP_BIN_RECODE[trips$SUBTOUR==1], breaks = c(seq(1,48, by=1), 9999), freq = NULL, right=FALSE, weight = trips$finalweight[trips$SUBTOUR==1])
