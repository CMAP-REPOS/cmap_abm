...
tourMode              <- c('Auto SOV','Auto 2 Person','Auto 3+ Person','Walk','Bike','Walk-Transit','PNR-Transit', 'KNR-Transit', 'TNC-Transit', 'School Bus', 'Ridehail')
tripMode              <- c('Auto SOV','Auto 2 Person','Auto 3+ Person','Walk','Bike','Walk-Transit','PNR-Transit', 'KNR-Transit', 'TNC-Transit', 'School Bus', 'Ridehail')
...
facility_types        <- c('Arterial', 'Freeway', 'Ramp1', 'Expressway', 'Ramp2', 'Connectors', 'Toll Plaza', 'Ramp3')
facility_codes        <- c(1, 2, 3, 4, 5, 6, 7, 8)
...
timePeriodBreaks      <- c(0, 7, 9, 13, 15, 23, 27, 31, 35, 49)
