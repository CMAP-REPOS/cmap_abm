...
todBins               <- c("03:00 AM to 04:00 AM", "04:00 AM to 05:00 AM", "05:00 AM to 06:00 AM"
                           ...
                           "10:00 PM to 11:00 PM","11:00 PM to 12:00 AM","12:00 AM to 01:00 AM","1:00 AM to 02:00 AM","2:00 AM to 03:00 AM")
tod_df                <- data.frame(id = seq(from=1, to=24), bin = todBins)
...
dur_df                <- data.frame(id = seq(from=1, to=24), bin = durBins)
...
tourMode              <- c('Auto SOV','Auto 2 Person','Auto 3+ Person','Walk','Bike','Walk-Transit','PNR-Transit', 'KNR-Transit', 'TNR-Transit',  'School Bus','Taxi')
tripMode              <- c('Auto SOV','Auto 2 Person','Auto 3+ Person','Walk','Bike','Walk-Transit','PNR-Transit', 'KNR-Transit', 'TNR-Transit', 'School Bus','Taxi')
...
#timePeriods           <- c("8pm-6am", "6-7am", "7-9am", "9-10am", "10-2pm", "2-4pm", "4-6pm", "6-8pm", "8pm-6am")
#timePeriodOrder       <- c("6-7am", "7-9am", "9-10am", "10-2pm", "2-4pm", "4-6pm", "6-8pm", "8pm-6am")
timePeriods           <- c("3-6am", "6-7am", "7-9am", "9-10am", "10-2pm", "2-4pm", "4-6pm", "6-8pm", "8pm-3am")
timePeriodOrder       <- c("3-6am", "6-7am", "7-9am", "9-10am", "10-2pm", "2-4pm", "4-6pm", "6-8pm", "8pm-3am")

timePeriodBreaks      <- c(0, 4, 5, 7, 8, 12, 14, 16, 18, 25)
