...
--------------------------------------------
### Auto Ownership{data-height=220}
...
### Telecommute Frequency{data-height=220}
...
### Percentage Working From Home{data-height=215}
```{r Chart_WFH}
...
Comparison of work productions, model vs. ACS Journey-To-Work 2015-2019. NOTE: this data is adjusted for work-from-home and incommuters.

**Tour Attractions by County**

Comparison of work attractions, model vs. ACS Journey-To-Work 2015-2019. NOTE: this data is adjusted for work-from-home and incommuters.
...
Census Data is from 2019 five year ACS.
...
ggplot(hnet[hnet$DY_CNT > 0,], aes(x = DY_CNT, y = DY_ASN)) + geom_point() +
  ...
  coord_fixed() + 
  xlim(0,max(max(hnet[!(is.na(hnet$DY_CNT)),]$DY_CNT),max(hnet[!(is.na(hnet$DY_ASN)),]$DY_ASN))) + 
  ylim(0,max(max(hnet[!(is.na(hnet$DY_CNT)),]$DY_CNT),max(hnet[!(is.na(hnet$DY_ASN)),]$DY_ASN)))
```
...
ggplot(hnet[hnet$NT_CNT > 0,], aes(x = NT_CNT, y = NT_ASN)) + geom_point() +
  ...
  coord_fixed() + 
  xlim(0,max(max(hnet[(!(is.na(hnet$NT_CNT)))&(!(is.na(hnet$NT_ASN))),]$NT_CNT),max(hnet[(!(is.na(hnet$NT_CNT)))&(!(is.na(hnet$NT_ASN))),]$NT_ASN))) + 
  ylim(0,max(max(hnet[(!(is.na(hnet$NT_CNT)))&(!(is.na(hnet$NT_ASN))),]$NT_CNT),max(hnet[(!(is.na(hnet$NT_CNT)))&(!(is.na(hnet$NT_ASN))),]$NT_ASN)))
```
...
ggplot(hnet[hnet$EA_CNT > 0,], aes(x = EA_CNT, y = EA_ASN)) + geom_point() +
  ...
  coord_fixed() + 
  xlim(0,max(max(hnet[!(is.na(hnet$EA_CNT)),]$EA_CNT),max(hnet[!(is.na(hnet$EA_ASN)),]$EA_ASN))) + 
  ylim(0,max(max(hnet[!(is.na(hnet$EA_CNT)),]$EA_CNT),max(hnet[!(is.na(hnet$EA_ASN)),]$EA_ASN)))
```
...
ggplot(hnet[hnet$AM_CNT > 0,], aes(x = AM_CNT, y = AM_ASN)) + geom_point() +
  ...
  coord_fixed() + 
  xlim(0,max(max(hnet[!(is.na(hnet$AM_CNT)),]$AM_CNT),max(hnet[!(is.na(hnet$AM_ASN)),]$AM_ASN))) + 
  ylim(0,max(max(hnet[!(is.na(hnet$AM_CNT)),]$AM_CNT),max(hnet[!(is.na(hnet$AM_ASN)),]$AM_ASN)))
```
...
ggplot(hnet[hnet$MM_CNT > 0,], aes(x = MM_CNT, y = MM_ASN)) + geom_point() +
  ...
  coord_fixed() + 
  xlim(0,max(max(hnet[!(is.na(hnet$MM_CNT)),]$MM_CNT),max(hnet[!(is.na(hnet$MM_ASN)),]$MM_ASN))) + 
  ylim(0,max(max(hnet[!(is.na(hnet$MM_CNT)),]$MM_CNT),max(hnet[!(is.na(hnet$MM_ASN)),]$MM_ASN)))
```
...
ggplot(hnet[hnet$MD_CNT > 0,], aes(x = MD_CNT, y = MD_ASN)) + geom_point() +
  ...
  coord_fixed() + 
  xlim(0,max(max(hnet[!(is.na(hnet$MD_CNT)),]$MD_CNT),max(hnet[!(is.na(hnet$MD_ASN)),]$MD_ASN))) + 
  ylim(0,max(max(hnet[!(is.na(hnet$MD_CNT)),]$MD_CNT),max(hnet[!(is.na(hnet$MD_ASN)),]$MD_ASN)))
```
...
ggplot(hnet[hnet$AF_CNT > 0,], aes(x = AF_CNT, y = AF_ASN)) + geom_point() +
  ...
  coord_fixed() + 
  xlim(0,max(max(hnet[!(is.na(hnet$AF_CNT)),]$AF_CNT),max(hnet[!(is.na(hnet$AF_ASN)),]$AF_ASN))) + 
  ylim(0,max(max(hnet[!(is.na(hnet$AF_CNT)),]$AF_CNT),max(hnet[!(is.na(hnet$AF_ASN)),]$AF_ASN)))
```
...
ggplot(hnet[hnet$PM_CNT > 0,], aes(x = PM_CNT, y = PM_ASN)) + geom_point() +
  ...
  coord_fixed() + 
  xlim(0,max(max(hnet[!(is.na(hnet$PM_CNT)),]$PM_CNT),max(hnet[!(is.na(hnet$PM_ASN)),]$PM_ASN))) + 
  ylim(0,max(max(hnet[!(is.na(hnet$PM_CNT)),]$PM_CNT),max(hnet[!(is.na(hnet$PM_ASN)),]$PM_ASN)))
```
...
ggplot(hnet[hnet$EV_CNT > 0,], aes(x = EV_CNT, y = EV_ASN)) + geom_point() +
  ...
  coord_fixed() + 
  xlim(0,max(max(hnet[!(is.na(hnet$EV_CNT)),]$EV_CNT),max(hnet[!(is.na(hnet$EV_ASN)),]$EV_ASN))) + 
  ylim(0,max(max(hnet[!(is.na(hnet$EV_CNT)),]$EV_CNT),max(hnet[!(is.na(hnet$EV_ASN)),]$EV_ASN)))
```
